...
echo deploy with URL: ${TEMPLATE_URL}

aws cloudformation update-stack --stack-name  ${CLOUDFORMATION_STACK} --template-url ${TEMPLATE_URL} --parameters "ParameterKey=SourceBuckets,UsePreviousValue=true"